    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="card mb-6">
        ...
        <div className="mt-4 p-4 bg-neutral-800/50 rounded-lg">
          <div className="text-sm text-neutral-400">
            <strong className="text-blue-500">{goalPlan.name}</strong> plan: 
        ...
        {filteredMeals.map((meal) => (
          <div key={meal.id} className="card">
            <div className="flex items-start justify-between mb-3">
              <div>
                <span className="text-xs text-blue-500 uppercase">{meal.category}</span>
                <h3 className="text-xl font-semibold">{meal.name}</h3>
              </div>
              <div className="text-right">
                <div className="text-2xl font-bold text-blue-500">{meal.calories}</div>
