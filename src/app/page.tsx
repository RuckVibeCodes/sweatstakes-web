    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 md:py-32">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/auth?mode=signup" className="btn-primary text-lg py-4 px-8">
                Join for ${entryFee}
              </Link>
      ...
      <section className="py-16 border-y border-neutral-800">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <div className="text-4xl font-bold text-green-500">${entryFee}</div>
      ...
      <section className="py-20 bg-neutral-900/50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="card">
              <div className="text-2xl font-bold text-green-500 mb-2">35%</div>
            ...
            <div className="card">
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-neutral-800">
                  ...
                  <span className="text-xl font-bold text-green-500">{prizeDistribution.grand_prize * 100}%</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-neutral-800">
                  <span className="text-lg">🥈 Second Place</span>
                  <span className="text-xl font-bold text-green-500">{prizeDistribution.second_place * 100}%</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-neutral-800">
                  <span className="text-lg">🥉 Third Place</span>
                  <span className="text-xl font-bold text-green-500">{prizeDistribution.third_place * 100}%</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-neutral-800">
                  <span className="text-lg">📈 Most Improved</span>
                  <span className="text-xl font-bold text-green-500">{prizeDistribution.most_improved * 100}%</span>
                </div>
                <div className="flex justify-between items-center py-3">
                  <span className="text-lg">⭐ Best Consistency</span>
                  <span className="text-xl font-bold text-green-500">{prizeDistribution.best_consistency * 100}%</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-t from-green-900/20 to-transparent">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <Link href="/auth?mode=signup" className="btn-primary text-lg py-4 px-12">
